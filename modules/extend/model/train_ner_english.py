...
def main():
    chosen_model_key = "sapbert"
    model_name = MODELS[chosen_model_key]
    output_dir = rf"models\{chosen_model_key}_ner_english"
    base_dir = r"data\viettel\vietnamese_ner\training\english\ner"
